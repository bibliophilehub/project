...
public class DateUtils {
    ...
    public static String timePattern5 = "yyMMddHHmmssssss";
     ...
     */
    public static final String dateToStrss(Date date) {
        SimpleDateFormat df = null;
        String returnValue = "";

        if (date != null) {
            df = new SimpleDateFormat(timePattern5);
            returnValue = df.format(date);
        }
    ...
    public static int daysBetween(Date smdate, Date bdate) {
        try {
        	...
        	}else if(smdate!=null && bdate==null){
                SimpleDateFormat sdf = new SimpleDateFormat(DEFAULT_FORMAT);
     ...
     * @throws ParseException
     */
    public static int compareDay(Date fdate, Date sdate) {
        try {
    ...
    public static void main(String[] a) throws ParseException {
        int i = daysBetween(new Date(), new SimpleDateFormat("yyyyMMdd").parse("20170303"));
...
//        System.out.println(DateUtils.getDate());
    ...
    public static Date formatDate(String dateStr){
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH");// 获取到完整的时间
        Date date = null;
        try{
