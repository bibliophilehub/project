...
/**
 * @Title IDCardValidate.java
 * @description TODO
 * @time 2017年12月13日 下午5:20:56
 * @author licheng
 * @version 1.0
 */
...
public class IDCardValidate {
    ...
    public static void main(String[] args) {
        //System.out.println(chekIdCard("441522199101024749"));  
        System.out.println(chekIdCard("142729196110132735"));
        System.out.println(chekIdCard("142729196103212729"));
        System.out.println(chekIdCard("14272919830525271X"));
        System.out.println(chekIdCard("142729195311182742"));
        System.out.println(chekIdCard("142729197412102712"));
        System.out.println(chekIdCard("142729197605212723"));
        System.out.println(chekIdCard("142729199609242726"));
        System.out.println(chekIdCard("142729200304282714"));
        System.out.println(chekIdCard("142729194308092717"));
        System.out.println(chekIdCard("142729196508252729"));
        System.out.println(chekIdCard("142729195109222712"));
        System.out.println(chekIdCard("142729195410182721"));
        System.out.println(chekIdCard("142729197712172712"));
        System.out.println(chekIdCard("142729197810132124"));
        System.out.println(chekIdCard("142729200206282729"));
        System.out.println(chekIdCard("142729197605106322"));
        System.out.println(chekIdCard("142729199904062728"));
        System.out.println(chekIdCard("140823201305260066"));
        System.out.println(chekIdCard("142729198206232756"));
        System.out.println(chekIdCard("142729197402072118"));
        System.out.println(chekIdCard("142729194109082743"));
        System.out.println(chekIdCard("14272919530921272X"));
        System.out.println(chekIdCard("142729195005152713"));
        System.out.println(chekIdCard("140823201412300043"));
        System.out.println(chekIdCard("142729199304282129"));
        System.out.println(chekIdCard("142729199403232725"));
        System.out.println(chekIdCard("14272919400302271844"));
        System.out.println(chekIdCard("142729199401192774"));
        System.out.println(chekIdCard("140823200512120029"));
        System.out.println(chekIdCard("142729195906044218"));
        System.out.println(chekIdCard("142729196204284828"));
        System.out.println(chekIdCard("14272919940815421X"));
        System.out.println(chekIdCard("142729193006094229"));
        System.out.println(chekIdCard("142729197503130022"));
        System.out.println(chekIdCard("142729195405014221"));
        System.out.println(chekIdCard("142729197604254219"));
        System.out.println(chekIdCard("142729196807192738"));
        System.out.println(chekIdCard("142729196805112722"));

        System.out.println(chekIdCard("140823201106190027"));
        System.out.println(chekIdCard("142729198709292726"));

        System.out.println(chekIdCard("142729198309192718"));
        System.out.println(chekIdCard("142729196305022720"));
        System.out.println(chekIdCard("142729196207112714"));
        System.out.println(chekIdCard("142729192905102726"));
        System.out.println(chekIdCard("142729199210032727"));
        System.out.println(chekIdCard("142729199502052738"));

        System.out.println(chekIdCard("14272919540927272x".toUpperCase()));
