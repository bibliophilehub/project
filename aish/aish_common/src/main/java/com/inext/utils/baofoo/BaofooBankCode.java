...
public class BaofooBankCode {
    ...
    public static String getBaofooBankCode(String number) {
        ...
        for (String code : BaofooBankCode.bankKV.keySet()
                ) {
            if (code.contains(codeName) || codeName.contains(code)) {
                return BaofooBankCode.bankKV.get(code);
            }
        }
        return null;
    }
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        System.out.println(BaofooBankCode.getBaofooBankCode("6236681300002011488 "));
