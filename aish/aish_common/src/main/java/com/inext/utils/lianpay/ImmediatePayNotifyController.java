...
import com.inext.utils.lianpay.bean.BusinessNoticeBean;
import com.inext.utils.lianpay.bean.NotifyResponseBean;
...
public class ImmediatePayNotifyController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/immediate/tradepayapi/receiveNotify", method = RequestMethod.POST)
	@ResponseBody
