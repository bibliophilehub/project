 ...
 *
 */
package com.inext.utils.baofoo.util;

import com.inext.utils.baofoo.http.*;
...
public class HttpUtil {
    ...
    public static String RequestForm(String Url, Map<String, String> Parms) {
        ...
        try {
            ...
            if (StringUtils.isEmpty(response.getEntityString())) {
                System.err.println("response error status code:" + response.getStatusCode());
            }
        } catch (Exception e) {
            return e.getMessage();
        }
