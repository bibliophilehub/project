 ...
 * @see DESCore
 */
public class JfwkDesUtil {

    private static String key1 = "syj";
    private static String key2 = "jfwk";
    private static String key3 = "JfwkDesUtil";

    public JfwkDesUtil() {
    }

    public static void main(String[] args) {
        JfwkDesUtil desObj = new JfwkDesUtil();
        String data = "15678906543";
        String str = desObj.strEnc(data, key1, key2, key3);
        System.out.println(str);
        String dec = desObj.strDec("96317EB32949386D6D136DC2F11F1C2B84445A12E266BE49", key1, key2, key3);
