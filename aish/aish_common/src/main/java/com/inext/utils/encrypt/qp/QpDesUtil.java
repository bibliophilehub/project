package com.inext.utils.encrypt.qp;
 ...
 * @see DESCore
 */
public class QpDesUtil {

    private static String key1 = "syj";
    private static String key2 = "qp";
    private static String key3 = "qpDesUtil";

    public QpDesUtil() {
    }

    public static void main(String[] args) {
        QpDesUtil desObj = new QpDesUtil();
