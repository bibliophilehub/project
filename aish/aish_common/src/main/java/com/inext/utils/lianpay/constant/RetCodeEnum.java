...
public enum RetCodeEnum {
	 ...
	 * @return
	 */
	public static boolean isNoMoney(String trade_code) {
		if (trade_code.equals(ACCOUNT_MENOY_LACK.code) || trade_code.equals(BEYOND_SINGLE_LIMIT.code)
				|| trade_code.equals(BEYOND_DAY_LIMIT.code) || trade_code.equals(BEYOND_MONDY_LIMIT.code)
				) {
			return true;
		}
		return false;
