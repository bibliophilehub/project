package com.inext.utils.lianpay;
...
public class PaymentApiTest {
	...
	public static void main(String[] args) throws Exception {
		...
		paymentRequestBean.setNo_order("20180413165934");
		paymentRequestBean.setDt_order("20180317165929");
		paymentRequestBean.setMoney_order("0.02");
		paymentRequestBean.setCard_no("6212261001046440399");
		paymentRequestBean.setAcct_name("李鹏");
		// paymentRequestBean.setBank_name("中国平安银行");
		paymentRequestBean.setInfo_order("test测试0.02?");
