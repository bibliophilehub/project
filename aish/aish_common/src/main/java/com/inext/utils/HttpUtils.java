...
public class HttpUtils {
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, Map param, boolean isproxy) {
    ...
    public static void main(String[] args) {
        //demo:代理访问
        String url = "http://101.37.16.180:443/xianjinxia/?token=Mnc1dHR5NHc0MWY4cTZ573S5O85C7N9W322";
        String para = "key=youkeyid&youuid=uid&advert_type=int&domain=adf.ly&url=http://somewebsite.com";

        //String sr=HttpUtils.sendPost(url,para);
