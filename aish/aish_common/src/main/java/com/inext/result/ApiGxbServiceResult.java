...
public class ApiGxbServiceResult<T extends BaseResult> implements Serializable {
    ...
    public ApiGxbServiceResult() {
    }


    public ApiGxbServiceResult(String code, String msg) {
        this.code = code;
        this.message = msg;
    }

    public ApiGxbServiceResult(String code, String msg, String result) {
        this.code = code;
        this.message = msg;
        this.result = result;
    }
