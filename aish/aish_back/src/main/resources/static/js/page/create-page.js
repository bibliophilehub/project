...
function createPager(page,formId) {
    ...
    pagerHtml += '<input type="button" value="GO" style="width:40px;height:20px;display:inline-block;padding:0;margin-left:5px;color: #fff;background-color: #4876e6;border-color: #4876e6;" onclick="javascript:xzpageNum();"/>&nbsp;&nbsp;&nbsp;';
    if (currentPage > 1) {
