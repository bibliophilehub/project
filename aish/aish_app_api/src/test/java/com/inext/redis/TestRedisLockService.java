package com.inext.redis;
/**
 * @Title TestRedisLockService.java
 * @description TODO
 * @time 2017年12月7日 下午6:58:58
 * @author licheng
 * @version 1.0
 */

import com.inext.utils.RedisLock;
...
public class TestRedisLockService {
    ...
    public void testTrylock() {
        ...
        RedisLock redisLock3 = new RedisLock(redisTemplate, lockKey);
